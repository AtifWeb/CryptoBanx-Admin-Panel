...
import { Drawer, Option, Select } from "@mui/joy";
import { Button } from "@/components/ui/button";
export const ReceivedEthDrawer = ({ open, setopen }: any) => {
    ...
    >
      ...
      <div className="py-[17px] px-[24px] flex flex-col flex-1">
        ...
        <h2 className="text-[16px] text-[#030915] mb-[16px]">
          Add Ethereum Address for Receive
        </h2>
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <div>
            ...
            <Select defaultValue="Ethereum" className="h-[45px]">
