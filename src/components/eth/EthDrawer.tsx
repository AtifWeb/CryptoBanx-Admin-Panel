      ...
      <div className="py-[17px] px-[24px] flex flex-col flex-1">
        <div className="border-[1px] mb-[17px] border-[#E1E6EB] px-[16px] py-[16px] rounded-[16px]">
          <div className="w-full flex flex-col items-center justify-center h-[93.8px] bg-[#030915] rounded-[12px] mb-[16px]">
            <h1 className="text-[25px] font-medium text-[#fff]">0.49098 ETH</h1>
        ...
        <div
          className="border-[1px] border-[#E1E6EB] px-[12px]
           py-[16px] mb-[16px] rounded-[13px]"
        >
          <h1 className="text-[16px] text-[#030915] mb-[12px]">Tokens</h1>

          <div className="flex items-center mb-3 p-3 border-[1px] border-[#E1E6EB] rounded-[8px]">
            <img
              src="/images/coins/eth.svg"
              className="w-[40px] h-[40px]"
              alt=""
            />
            <p className="flex-1 text-[16px] font-normal ml-[10px]">Ethereum</p>
            <div>
              <p className="text-[14px] font-normal text-[#030915]">0.2 ETH</p>
              <p className="text-[12px] font-normal text-[#525A65]">$601.200</p>
            </div>
          </div>
          <div className="flex items-center mb-3 p-3 border-[1px] border-[#E1E6EB] rounded-[8px]">
            <img
              ...
              alt=""
            />
            <p className="flex-1 text-[16px] font-normal ml-[10px]">USDT </p>
            <div>
              <p className="text-[14px] font-normal text-[#030915]">10 USDT</p>
              <p className="text-[12px] font-normal text-[#525A65]">$10.00</p>
            </div>
          </div>
          <div className="flex items-center p-3 border-[1px] border-[#E1E6EB] rounded-[8px]">
            <img
              src="/images/coins/usdc.svg"
              className="w-[40px] h-[40px]"
              alt=""
            />
            <p className="flex-1 text-[16px] font-normal ml-[10px]">USDC </p>
            <div>
              <p className="text-[14px] font-normal text-[#030915]">2 USDC</p>
              <p className="text-[12px] font-normal text-[#525A65]">$2.00</p>
            </div>
          </div>
        </div>
